  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-sans",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-accent text-white hover:opacity-90 hover:scale-[1.03] shadow-elevated glow-violet",
        heroOutline:
          "border border-border bg-secondary/40 text-foreground backdrop-blur-md hover:border-primary/60 hover:bg-secondary/70 hover:glow-violet",
        accent:
          "bg-primary/15 border border-primary/40 text-foreground hover:bg-primary/25 hover:border-primary/70 backdrop-blur-md",
      },
      size: {
